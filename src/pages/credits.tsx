...
<div className={styles.main}>
    ...
    <ul className={styles.list}>
        <li>Built using <a href="http://www.docusaurus.io">Docusaurus</a>.
            <p className={styles.explain}><em>But enig,</em> you say, <em>Docusaurus isn't for personal webpages.</em> Not only
                do I say, <em>Why not?</em> to that but also <em>You can't stop me.</em> I'm a baby coder and not quite
                ready to build my entire environment from scratch, and Docusaurus gives me a basic tool to beat into
                submission into what I want. It comes with the fancy code I can use to self-host a blog and a personal
                knowledge bank while I mess around trying to learn Javascript and React. It's a win/win!
            </p>
        </li>
        <li>Hosted by <a href="https://neocities.org" target="_blank">neocities.org</a>.</li>
    </ul>
    <h2>Fonts</h2>
    <ul className={styles.list}>
        <li>Google
